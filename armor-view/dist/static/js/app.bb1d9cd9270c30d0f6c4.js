        ...
        step: {
            ...
            handler: function (val, oldVal) {
                ...
                if (this.step.userId != '' && this.step.taskHours != '' && this.step.beginTime != '' && this.step.endTime != '') {
                    this.weekTime.beiginWeek = __WEBPACK_IMPORTED_MODULE_2_moment___default()(this.step.beginTime).week();
                    ...
                    if (beginYear != endYear) {
                        console.log(__WEBPACK_IMPORTED_MODULE_2_moment___default()().week());
    ...
    watch: {
        taskForm: {
            handler: function (val, oldVal) {
                ...
                let weekData = '';
                if (this.taskForm.endTime != '') {
                    var beginWeek = __WEBPACK_IMPORTED_MODULE_4_moment___default()(this.taskForm.beginTime).week();
                    var endWeek = __WEBPACK_IMPORTED_MODULE_4_moment___default()(this.taskForm.endTime).week();
...
//# sourceMappingURL=app.bb1d9cd9270c30d0f6c4.js.map