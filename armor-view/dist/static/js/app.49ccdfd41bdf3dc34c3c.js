...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_vm._l((_vm.taskItems), function(task) {
    ...
    return _c('div', {
      ...
      slot: "content"
    }, [_vm._v(_vm._s(item.description)), _c('br'), _vm._v("开始时间:" + _vm._s(_vm._f("formatDate")(item.createTime)))]), _vm._v(" "), _c('span', {
      staticClass: "fl",
      staticStyle: {
        "margin-left": "25px"
      }
    ...
    staticClass: "star"
  }, [_vm._v("*")]), _vm._v("开发日期")]), _vm._v(" "), _c('el-date-picker', {
    attrs: {
      "type": "date",
      "format": "yyyy-MM-dd",
      "placeholder": "选择日期时间"
    ...
    staticClass: "star"
  }, [_vm._v("*")]), _vm._v("提测日期")]), _vm._v(" "), _c('el-date-picker', {
    attrs: {
      "type": "date",
      "format": "yyyy-MM-dd",
      "placeholder": "选择日期时间"
...
//# sourceMappingURL=app.49ccdfd41bdf3dc34c3c.js.map