        ...
        saveTaskInfo(formName) {
            ...
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    console.log(__WEBPACK_IMPORTED_MODULE_4_moment___default()().week());
                    if (__WEBPACK_IMPORTED_MODULE_4_moment___default()(param.endTime).week() != __WEBPACK_IMPORTED_MODULE_4_moment___default()().week()) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getWeeks() {
            //一年工多少周
            this.weekOption = [];
            for (var i = 1; i <= __WEBPACK_IMPORTED_MODULE_4_moment___default()().weeksInYear(); i++) {
    ...
    watch: {
        step: {
            ...
            handler: function (val, oldVal) {
                ...
                let weekData = '';
                if (this.step.userId != '' && this.step.taskHours != '' && this.step.beginTime != '' && this.step.endTime != '') {
                    this.weekTime.beiginWeek = __WEBPACK_IMPORTED_MODULE_1_moment___default()(this.step.beginTime).week();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.userWeekForm.userId),
      callback: function($$v) {
        _vm.$set(_vm.userWeekForm, "userId", $$v)
      },
      expression: "userWeekForm.userId"
    }
  }, _vm._l((_vm.userList), function(item) {
    return _c('el-option', {
      key: item.id,
    ...
    model: {
      value: (_vm.userWeekForm.weekNumber),
      callback: function($$v) {
        _vm.$set(_vm.userWeekForm, "weekNumber", $$v)
      },
      expression: "userWeekForm.weekNumber"
    }
  }, _vm._l((_vm.weekOption), function(item) {
    return _c('el-option', {
      key: item.id,
      attrs: {
        "label": item.name,
    ...
    on: {
      "click": function($event) {
        _vm.userWeekForm.weekNumber = _vm.currentWeek
      }
    }
...
//# sourceMappingURL=app.4154fc72177a41d2685b.js.map