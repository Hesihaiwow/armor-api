<template>
    <div class="demand-con">
      <div>
        <el-tabs @tab-click="" active-name="new" style="position:relative;margin-bottom: 20px;">
          <el-tab-pane label="新需求" name="new">
              ...
              <div class="clearfix">
                <div class="demand-top-list fl">
                  ...
                  <el-select clearable filterable  v-model="priority" placeholder="请选择" size="small" style="width:100px;margin-left: -50px">
                    <el-option v-for="item in prioritys" :key="item.id" :label="item.priority"
                ...
                <div class="demand-top-list fl">
                  ...
                  <el-select clearable filterable  v-model="type" placeholder="请选择" size="small" style="width:100px;margin-left: -50px">
                    <el-option v-for="item in types" :key="item.id" :label="item.type"
                               :value="item.id"></el-option>
                  </el-select>
                  <!--    @click="addFormTagId(item.id,1,$event)"-->
                </div>
                ...
                <div class="demand-top-list fl">
                  ...
                  <el-select clearable filterable  v-model="user" placeholder="请选择" size="small" style="width:100px;margin-left: -50px">
                ...
                <el-button type="primary" size="small" @click="newDemandVisible=true,clearFeedbackForm()" v-show="permit">提需求</el-button>
              </div>
            </div>
            ...
            <el-table :data="demandData" border>
              ...
              <el-table-column  label="来源" align="center" width="100"></el-table-column>
          ...
          <el-tab-pane label="进行中" name="stat"></el-tab-pane>
          <el-tab-pane label="排队中" name="stat"></el-tab-pane>
          <el-tab-pane label="不采纳" name="stat"></el-tab-pane>
          <el-tab-pane label="已完成" name="stat"></el-tab-pane>
      ...
      <el-dialog :visible.sync="newDemandVisible" title="提需求"  custom-class="myDialog" :close-on-click-modal="false" :close-on-press-escape="false">
        <el-form :model="newDemandForm" ref="feedbackForm" :rules="rules" label-width="110px" :inline="true" >
          <el-form-item label="需求标题:"  prop="title" >
            <el-input type="text" v-model="newDemandForm.title" clearable></el-input>
          </el-form-item><br>
          ...
          <el-form-item label="优先级:" prop="priority">
            <el-select v-model="newDemandForm.priority" placeholder="请选择">
              <el-option
          ...
          <el-form-item label="问题:" prop="question">
            <el-input type="textarea" v-model="newDemandForm.question" placeholder="请简单描述提出该需求要解决什么问题" clearable resize="horizontal"></el-input>
          </el-form-item><br>
          <el-form-item label="目标:"  prop="target">
            <el-input type="textarea" v-model="newDemandForm.target" placeholder="请简单描述怎么做，你认为能解决问题" clearable
            resize="horizontal" ></el-input>
          </el-form-item><br>
          <el-form-item label="提出日期:" prop="feedbackTime"  >
            <el-date-picker
                    v-model="newDemandForm.createTime"
                    type="date"
                    format="yyyy-MM-dd"
                    placeholder="选择日期时间">
            </el-date-picker>
        ...
        methods: {
            ...
            select(){
                ...
                if (this.priority){
                    ...
                    this.reqDTO.priority = this.priority - 1
                }
                if (this.type){
                    if (this.type == 0){
                        this.reqDTO.type = null
                    }
                    this.reqDTO.type = this.type - 1
                }
                if (this.readStatus){
                    if (this.readStatus == 0){
                        this.reqDTO.readStatus = null
                    }
                    this.reqDTO.readStatus = this.readStatus - 1
                }
                if (this.origin){
                    this.reqDTO.origin = this.origin
                }
                if (this.user){
                    this.reqDTO.user = String(this.user)
                }
            },
            clearFeedbackForm(){
