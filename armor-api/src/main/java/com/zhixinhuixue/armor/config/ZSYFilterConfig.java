...
public class ZSYFilterConfig {
    ...
    public FilterRegistrationBean urlFilter(){
        ...
        frb.addInitParameter("exclusions",String.format("*.js,*.gif,*.jpg,*.png,*.css,*.ico,*.eot,*.svg,*.ttf,*.woff,*.woff2,/swagger-resources,/swagger-resources/*,/druid/*,*.html,/v2/api-docs,%s", ZSYConstants.LOGIN_URI));
        return frb;
    }
