...
public class ZSYFilterConfig {
    ...
    public FilterRegistrationBean urlFilter(){
        ...
        frb.addInitParameter("exclusions",String.format("*.js,*.gif,*.jpg,*.png,*.css,*.ico,*.eot,*.svg,*.ttf,*.woff,*.woff2,*.map,/swagger-resources,/swagger-resources/*,/druid/*,*.html,/v2/api-docs,%s", ZSYConstants.LOGIN_URI+","+ ZSYConstants.REGISTER_URI + ","+ ZSYConstants.ADMIN_LOGIN_URI));
        return frb;
    }
