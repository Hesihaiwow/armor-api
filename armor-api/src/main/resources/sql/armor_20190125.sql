...
ALTER TABLE bug_manage add COLUMN discover_time datetime DEFAULT NULL COMMENT '发现时间';
ALTER TABLE bug_manage MODIFY COLUMN create_time datetime DEFAULT NULL COMMENT '创建时间';